...
- 当前已形成至D85的学习记录；中间未完成Day不会因最高编号变化而自动补记或标记Done。
- 当前最高编号学习笔记：[[Day85-原生Page模板与正文样式边界]]（隔离Local技术验证；正式内容与非Local仍待）。
...
| Day59 | [[Day59-响应式单品布局与主题配置边界]] | [[../Day59-商品详情四端购买区与Sticky收口\|Day59-商品详情四端购买区与Sticky收口]] | 初识，待费曼自测 | — | DentAll 0.34.0用同一经典单品DOM在768～1199px形成Gallery→Summary满宽堆叠，1200px恢复D55双列；同步修正Gallery `sizes`并让五图缩略图从768px起封顶100px。Local原生Sticky配置关闭，正常/多图六宽、缺图/长文本各四宽、推荐命中、数据恢复及独立复核通过；D61动态Variation、正式内容和非Local仍待 |
| Day60 | [[Day60-代表内容压力测试与可逆验收]] | [[../Day60-商品详情代表内容回归与W10收口\|Day60-商品详情代表内容回归与W10收口]] | 初识，待费曼自测 | — | 业务来源材料仅在一次性隔离Local作为代表TEST输入；Simple/Variable初始、长文案、五图、缺图、售罄、无价格、一次Simple加购及D64/D65边界共30页、419/419。商品/session/附件/69张派生图/账号精确恢复，运行代码0改动；正式内容、D61动态Variation和非Local仍待 |
| Day61 | [[Day61-变体生命周期与展示语义]] | [[../Day61-原生变体选择与购买验证\|Day61-原生变体选择与购买验证]] | 初识，待费曼自测 | — | 原生inline/AJAX数据合同、shared sizes、show/hide与ARIA、Quantity继承、六宽动态状态、键盘/匿名/Customer加购与恢复；明确Woo原生AJAX错误体验P2转D66，不把服务端拒绝与展示体验混同 |
| Day62（并行） | [[Day62-WooCommerce原生字段与ACF启用边界]] | [[../Day62-原生字段复核与零扩展收口\|Day62-原生字段复核与零扩展收口]] | 初识，待费曼自测 | — | 从原生字段职责、实际插件包、保存与输出链解释零扩展决定；区分ACF定义与值、PDF链接与访问权限、停用与许可。只读核验与文档收口，不宣称新增字段、保存/恢复或四端验收 |
| Day63（并行） | [[Day63-WooCommerce附加信息与公开文件边界]] | [[../Day63-原生扩展信息与公开资料空状态\|Day63-原生扩展信息与公开资料空状态]] | 初识，待费曼自测 | — | WooCommerce 11.0.0以正文、可见属性和重量/尺寸决定原生Tab；当前23/23运行文件一致后复用#44/#46四端页面与单一键盘路径证据。普通uploads按匿名公开管理，PDF和5MB权限边界保持；当前无合格文件所以入口0，运行代码0变更、数据库业务/配置显式写入0，本轮未做全表前后哈希 |
| Day64并行 | [[Day64-WooCommerce关联商品与原生循环边界]] | [[../Day64-原生关联商品与推荐空状态\|Day64-原生关联商品与推荐空状态]] | 初识，待费曼自测 | — | 原生来源、After Summary、上限与Grid分责、角色可见性、空态与跨区排除、隔离TEST恢复均已记录；代码净48行，动态矩阵、间距P2修复、业务字段恢复/清理及独立复核通过，并已纳入`main`。SEO合成复核通过，Sticky局部遮图P3已由D59关闭；D60其后另行回归，不代替用户掌握度或Production验收 |
| Day66 | [[Day66-集成基线与商品全链路回归]] | [[../Day66-商品浏览闭环集成回归]] | 初识，待费曼自测 | — | 保留9月8日失败证据，并记录9月10日授权关闭：DentAll 0.41.0跟踪当前Woo AJAX安全状态、精确移除商品详情Product Pagination、局部修复属性表长词；最终独立19/19＋6/6、四端24/24＋12/12且页面错误0，独立变体回归合计61/61，安全/交易终审P0～P3=0。D66/M5按Local技术口径完成，真实读屏器、非Local与费曼自测仍待 |
...
| Day73 | [[Day73-WooCommerce报价字段与客户身份边界]] | [[../Day73-报价字段与客户身份合同]] | 初识，Local技术验收完成 | — | Cart自动商品事实、邮件地址合同、Woo原生Billing/Shipping、Guest付款与Customer显式关联分层；PHP 59/59、邮件JavaScript 46/46及真实Woo/展示Filter负向40/40、权限/四端浏览器通过，不把邮箱格式当身份验证 |
| Day75 | [[Day75-WooCommerce报价过期与订单生命周期]] | [[../Day75-人工物流与报价72小时生命周期]] | 初识，Local技术验收完成 | — | 首次成功发送付款邮件起算、重发不续期、异步调度与实时守卫共用到期事实；生命周期83/83、真实队列、HTTP终态及普通停用3/3通过，并发首次签发P3、静默更新和第三方私有对象meta P2及D76/D78真实网关仍待 |
| Day77 | [[Day77-WordPress事务邮件链与可观察性]] | [[../Day77-FluentSMTP事务邮件Local验证]] | 初识，待费曼自测 | 2026-09-22 | Woo邮件、`wp_mail()`、FluentSMTP、BossMail、真实收件与日志分层；Local隔离链和Staging外部收件已通过，Header认证及完整业务触发仍待 |
...
| Day85（并行检查点） | [[Day85-原生Page模板与正文样式边界]] | [[../Day85-通用内容页模板与编辑回归]] | 初识，待费曼自测 | 2026-09-21 | 原生Page与Full width模板责任、正文阅读宽度、长token、全局样式作用域、四端/键盘/SEO和Gutenberg精确恢复；仅隔离Local通过 |
...
D62与D63分别完成字段复核、原生展示和公开资料空状态学习收尾；D59～D61也已独立完成，本轮汇齐既有学习记录，不重写各Day当时的证据范围。

D70已依据实际原生优惠券矩阵、独立交易复核与精确恢复形成学习记录；技术证据完成不自动代表用户掌握，费曼自测仍由用户本人执行。

## 并行学习检查点

| 工作日 | 学习笔记 | 项目笔记 | 当前边界 |
|---|---|---|---|
| Day65 | [[Day65-渲染生命周期与结构化数据去重]] | [[../Day65-商品详情结构化数据与SEO边界]] | 隔离Local输出分支、去重、169项HTTP断言及四端已验证；D58/D62/D64主分支合成后Schema/DOM、推荐网格和Simple购物车回归通过。本人费曼自测、公开验证器与非Local仍待，不提前修改顺序主线 |
