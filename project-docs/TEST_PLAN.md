...
Core0.2.8在`127.0.0.1:16565`：12页前后+4页Yoast退出分支169/169断言通过；2个商品×390/768/1024/1440无页面横向溢出，可见面包屑和H1均1；缺货提示、ArrowDown/Enter与3px focus、Console检查通过。独立Review和10项PHP分支检查无当前范围P0/P1/P2；没有改源Local、商品事实或购买逻辑。

必须在D62/D64合并后重跑最终Schema/DOM/四端；D58/D61数量可见标签、缺货按钮disabled语义仍为继承待办。Google/Schema在线验证、屏幕阅读器、实体设备、正式品牌/评价、非Local缓存与CWV未验。详细测试命令、源25表不变量、证据和P3升级边界见[[笔记/Day65-商品详情结构化数据与SEO边界]]。
