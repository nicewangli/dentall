...
| 清理与停机 | 标记订单0、checkout draft 0、报价TEST option 0；17171/17172监听0、PID文件0；68份脱敏证据4,847,866字节私密归档且清单SHA-256为`70be729e537f8d4ce22e31f80d0c7e5899d4b4c4a203c03e016b41972f455820`；`fb49`登记移除、源目录0文件/0子目录 | 归档由Git忽略且排除数据库/SQL/凭据/日志/密钥/运行副本；Windows只保留被当前任务占用的空壳目录名，其他工作树未动 |
