...
- Product、Offer、品牌和评价继续从Woo原生事实输出；不新增第二份Product，也不将展示参考价格或推测业务内容写进Offer。D62零扩展结论已合入；D61动态变体完成后仍须重新验收。
...
- 完整证据及回滚见[[笔记/Day65-商品详情结构化数据与SEO边界]]；D58/D62/D64合成后的最终DOM与Schema复验已通过，公开环境、在线结构化数据工具和缓存复验仍待。
